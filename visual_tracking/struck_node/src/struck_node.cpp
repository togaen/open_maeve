...
int main(int argc, char* argv[]) {
  ...
  // For convenience.
	...
	auto init_sub = nh.subscribe(params.init_tracker_topic, params.init_tracker_topic_queue_size, &ma_core::StruckTracker::userInitCallback, &struck_tracker);

	// Set camera image stream topic.
	auto camera_sub = nh.subscribe(params.camera_topic, params.camera_topic_queue_size, &ma_core::StruckTracker::cameraCallback, &struck_tracker);
